...
void IntervalMode::addSecond(){
totalSeconds+=1;

}
void IntervalMode::changeEditAttribute(){
hmsActive +=1;
if (hmsActive >3){
hmsActive=0;
}
}
void IntervalMode::subtractValue(){
	if (edit==true){
		switch (hmsActive){
		case 0 :
			Hours -=1;
...
String IntervalMode::getCurrentValue(){
...
long IntervalMode::getTotalSeconds(){
return totalSeconds;
}
String IntervalMode::sayHello(){
